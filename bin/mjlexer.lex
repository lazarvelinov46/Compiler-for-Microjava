...
"[" 		{ return new_symbol(sym.LMED, yytext()); }
"]" 		{ return new_symbol(sym.RMED, yytext()); }
"{" 		{ return new_symbol(sym.LBRACE, yytext()); }
"}"			{ return new_symbol(sym.RBRACE, yytext()); }
"=>" 		{ return new_symbol(sym.RARROW, yytext()); }
"#"			{ return new_symbol(sym.TARABA, yytext()); }
"^"			{ return new_symbol(sym.STEPEN, yytext()); }
...
. { System.err.println("Leksicka greska ("+yytext()+") na poziciji "+(yycolumn+1)+" u liniji "+(yyline+1)); }
